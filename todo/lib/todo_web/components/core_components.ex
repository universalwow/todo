defmodule TodoWeb.CoreComponents do
  ...
  This app embeds a small set of icons directly to avoid relying on git-based
  ...
  def icon(%{name: "hero-moon-micro"} = assigns) do
    ...
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M10.8 11.6A5.5 5.5 0 0 1 6.2 2.9a4.7 4.7 0 1 0 4.6 8.7z" />
    </svg>
    """
  end

  def icon(assigns) do
    assigns = assign_new(assigns, :class, fn -> "size-4" end)
